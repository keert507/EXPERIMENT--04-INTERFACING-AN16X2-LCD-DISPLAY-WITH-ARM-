...
{
    Lcd_cursor(&lcd, 0, 1);
    Lcd_string(&lcd, "KEERTHANA T\n");

    Lcd_cursor(&lcd, 1, 1);
    Lcd_string(&lcd, "212224100031\n");
}
...
## Output screen shots of proteus  :
 ...
 <img width="1079" height="758" alt="Screenshot 2025-09-22 094156" src="https://github.com/user-attachments/assets/8947b830-03f7-4126-89e8-77efa85767a8" />

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

 <img width="1201" height="844" alt="image" src="https://github.com/user-attachments/assets/52718e37-2b27-4919-be01-65382d68de6b" />
